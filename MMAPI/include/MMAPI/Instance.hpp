...
namespace MMAPI::Instance
{
	enum class Objects : int
	{
		...
		MonsterBarrel,
		MonsterBat,
		MonsterBatSonicAttack,
		MonsterBatSonicBoom,
		MonsterCat,
		MonsterClod,
		MonsterClodBomb,
		MonsterClodProjectile,
		MonsterEnchantern,
		MonsterEnchanternProjectile,
		MonsterMimic,
		MonsterMite,
		MonsterMiteSecondary,
		MonsterRockStack,
		MonsterSap,
		MonsterShroom,
		MonsterSpirit,
		MonsterSpiritProjectile,
		MonsterStars,
		MonsterStatue,
		MonsterTome,
	...
	namespace Internal
	{
		...
		inline constexpr const char* ToObjectName(MMAPI::Instance::Objects obj)
		{
			switch (obj)
			{
				...
				case MMAPI::Instance::Objects::MonsterBarrel:               return "obj_monster_barrel";
				case MMAPI::Instance::Objects::MonsterBat:                  return "obj_monster_bat";
				case MMAPI::Instance::Objects::MonsterBatSonicAttack:       return "obj_monster_bat_sonic_attack";
				case MMAPI::Instance::Objects::MonsterBatSonicBoom:         return "obj_monster_bat_sonic_boom";
				case MMAPI::Instance::Objects::MonsterCat:                  return "obj_monster_cat";
				case MMAPI::Instance::Objects::MonsterClod:                 return "obj_monster_clod";
				case MMAPI::Instance::Objects::MonsterClodBomb:             return "obj_monster_clod_bomb";
				case MMAPI::Instance::Objects::MonsterClodProjectile:       return "obj_monster_clod_projectile";
				case MMAPI::Instance::Objects::MonsterEnchantern:           return "obj_monster_enchantern";
				case MMAPI::Instance::Objects::MonsterEnchanternProjectile: return "obj_monster_enchantern_projectile";
				case MMAPI::Instance::Objects::MonsterMimic:                return "obj_monster_mimic";
				case MMAPI::Instance::Objects::MonsterMite:                 return "obj_monster_mite";
				case MMAPI::Instance::Objects::MonsterMiteSecondary:        return "obj_monster_mite_secondary";
				case MMAPI::Instance::Objects::MonsterRockStack:            return "obj_monster_rock_stack";
				case MMAPI::Instance::Objects::MonsterSap:                  return "obj_monster_sap";
				case MMAPI::Instance::Objects::MonsterShroom:               return "obj_monster_shroom";
				case MMAPI::Instance::Objects::MonsterSpirit:               return "obj_monster_spirit";
				case MMAPI::Instance::Objects::MonsterSpiritProjectile:     return "obj_monster_spirit_projectile";
				case MMAPI::Instance::Objects::MonsterStars:                return "obj_monster_stars";
				case MMAPI::Instance::Objects::MonsterStatue:               return "obj_monster_statue";
				case MMAPI::Instance::Objects::MonsterTome:                 return "obj_monster_tome";
